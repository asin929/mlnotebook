...
  问题来了，这个$$\nu$$能不能在一定程度上代表了$$\mu$$。也许不能，因为即使bin中orange占多数，也可能发生这样的事情，你抽了10个小球出来但全是green的。但这种事情发生的可能性大吗？不大，并且如果我们有更多的样本\(抽出更多的球\)，则这种事情发生的可能性会越来越小。在概率论中，可以用\[Hoeffding's Inequality\]\([http://en.wikipedia.org/wiki/Hoeffding's\_inequality\)来描述上面那件事情的概率：](http://en.wikipedia.org/wiki/Hoeffding's_inequality%29来描述上面那件事情的概率：)
